...
from tastyauth.tornado import httpclient
from tastyauth.tornado import escape
from tastyauth.tornado.escape import _unicode
from tastyauth.tornado.httputil import url_concat, bytes_type, b
...
class GenericAuth(object):
    ...
    def set_cookie(self, name, value, domain=None, expires=None, path="/",
        ...
        """
        assert self.cookie_monster, 'Cookie Monster not set'
        self.cookie_monster.set_cookie(name, value)#, domain=domain, path=path)

    def clear_cookie(self, name, path="/", domain=None):
        """Deletes the cookie with the given name."""
        assert self.cookie_monster, 'Cookie Monster not set'
        self.cookie_monster.delete_cookie(name)#, path=path, domain=domain)
